...
CONFIG = {
    "EXPERIMENT_NAME": "51_kaggle_16_clean_split_then_balance",
    "DESCRIPTION": "Parameters and architecture from 16, but using cleaned and corrected dataset. This time split first then balance the data, as previously but incorrectly.",
