...
CONFIG = {
    "EXPERIMENT_NAME": "52_kaggle_16_split_then_bal_nostop",
    "DESCRIPTION": "Parameters and architecture from 16, but using cleaned and corrected dataset. This time split first then balance the data, as previously but incorrectly. No early stopping",
