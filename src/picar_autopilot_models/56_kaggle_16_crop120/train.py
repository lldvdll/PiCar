...
CONFIG = {
    "EXPERIMENT_NAME": "56_kaggle_16_crop120",
    "DESCRIPTION": "Parameters and architecture from 16, but using cleaned and corrected dataset, adding more data from youssef. Balance then split, no early stopping, 250 epochs, crop top 120",
