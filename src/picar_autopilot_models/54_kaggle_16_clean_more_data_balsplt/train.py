...
CONFIG = {
    "EXPERIMENT_NAME": "54_kaggle_16_clean_more_data_balsplt",
    "DESCRIPTION": "Parameters and architecture from 16, but using cleaned and corrected dataset, adding more data found on car. Balance then split, no early stopping",
