...
CONFIG = {
    "EXPERIMENT_NAME": "55_kaggle_16_clean_youssef_bl_e250",
    "DESCRIPTION": "Parameters and architecture from 16, but using cleaned and corrected dataset, adding more data from youssef. Balance then split, no early stopping, 250 epochs",
