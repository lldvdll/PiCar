...
CONFIG = {
    "EXPERIMENT_NAME": "59_more_more_aug",
    "DESCRIPTION": "57, but with more agressive lighting, cutout, and rotation augmentation",
...
# --- Data Augmentation ---
    ...
    "AUG_CUTOUT_MAX_PIX": 70,      # Maximum mask size
